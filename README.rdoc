...
This is a fork of the Retweet application template by zapnap.
I have changed it from using DataMapper to ActiveRecord, as I wanted to have a play with it today, but there appears to be an issue with extlib/mash conflicts when using the original DM version.
